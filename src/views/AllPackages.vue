<template>
  <div class="packages-conatiner">
    ...
    <div class="container">
      ...
      <div class="package" v-for="pkg in packages" v-bind:key="pkg._id" @click="detail(pkg)">
    ...
    <div class="modal grid" v-show="isDetailOpen">
      ...
      <button v-show="detailed.status==0" class="btn-green" @click="confirmUpdate()">COMPLETAR</button>
...
export default {
  ...
  methods: {
    ...
    confirmDeletion(){
      let isConfirmed= confirm('se ELIMINARÁ el paquete con id num:'+ this.detailed._id+' \n Si desea continuar presione aceptar');
      if(isConfirmed){
    ...
    confirmUpdate(){
       let isConfirmed= confirm('El paquete con id: '+ this.detailed._id+' há sido recogido' );
      if(isConfirmed){
        this.updatePkg(this.detailed._id);
        this.isDetailOpen = false
      }
    }
  }

<template>
  <div class="packages-conatiner">
    ...
    <div class="container">
      ...
      <div class="package" v-for="pkg in packages" v-bind:key="pkg._id" @click="detail(pkg)" v-if="pkg.status==0">
    ...
    <div class="modal grid" v-show="isDetailOpen">
      ...
      <button class="btn-green" @click="confirmUpdate()">COMPLETAR</button>
